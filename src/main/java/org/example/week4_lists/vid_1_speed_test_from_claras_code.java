...
public class vid_1_speed_test_from_claras_code {
...
//output:
// Generating 1 million random numbers.......done. Created LinkedList and ArrayList containing same data
//
//Testing ArrayList. Please wait...
//time taken to remove items one by one from start of ArrayList  = 939ms
//Testing LinkedList. Please wait...
//time taken to remove items one by one from start of LinkedList  = 16ms
//
//Testing ArrayList. Please wait...
//Time taken to add elements to the start of ArrayList  = 2634ms
//Testing LinkedList. Please wait...
//Time taken to add elements to the start of LinkedList  = 10ms
//
//Testing ArrayList. Please wait...
//Total of all numbers in ArrayList = 49935248
//time taken to sum elements in ArrayList with a regular for loop = 3ms
//Testing LinkedList. Please wait...
//time taken to sum elements in LinkedList with a regular for loop = 15717ms
//
//Testing ArrayList. Please wait...
//Total of all numbers in ArrayList = 49935248
//time taken to sum elements in ArrayList with a for each loop = 34ms
//Testing LinkedList. Please wait...
//time taken to sum elements in LinkedList with a for each loop = 14ms
//
//Testing ArrayList. Please wait...
//Time taken to add elements to the end of ArrayList  = 520ms
//Testing LinkedList. Please wait...
//Time taken to add elements to the end of LinkedList  = 1038ms
